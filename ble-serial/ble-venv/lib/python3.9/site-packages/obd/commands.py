...
__mode1__ = [
    ...
    OBDCommand("RPM"                        , "Engine RPM"                              , b"010C1", 4, uas(0x07),             ECU.ENGINE, True),
    OBDCommand("SPEED"                      , "Vehicle Speed"                           , b"010D1", 3, uas(0x09),             ECU.ENGINE, True),
    ...
    OBDCommand("THROTTLE_POS"               , "Throttle Position"                       , b"01111", 3, percent,               ECU.ENGINE, True),
    ...
    OBDCommand("RUN_TIME"                   , "Engine Run Time"                         , b"011F1", 4, uas(0x12),             ECU.ENGINE, True),
    ...
    OBDCommand("FUEL_RATE"                  , "Engine fuel rate"                        , b"015E1", 4, fuel_rate,             ECU.ENGINE, True),
    OBDCommand("EMISSION_REQ"               , "Designed emission requirements"          , b"015F", 3, drop,                  ECU.ENGINE, True),
    OBDCommand("ODO_METER"                  , "Odometer"                                , b"01A61", 4, uas(0x25),             ECU.ENGINE, True),
]
